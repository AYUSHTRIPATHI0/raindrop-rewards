        ...
        <Card>
          ...
          <CardContent>
            <p className="mb-4 text-muted-foreground">
              Discover compelling reasons to start conserving water today. Click the button to get AI-powered facts.
            </p>
            <Button onClick={handleFetchFacts} disabled={factsLoading}>
